    ...
    <div className="flex flex-col flex-1 items-center justify-center p-16">
      <div className="w-full max-w-3xl text-center">
        ...
        >
          <Typography
            variant="h1"
            className="mt-48 sm:mt-76 text-4xl md:text-7xl font-extrabold tracking-tight leading-tight md:leading-none text-center"
          >
            Terjadi kesalahan!
          </Typography>
        </motion.div>
        ...
        >
          ...
          >
            Maaf, sedang terjadi kesalahan pada server. Silakan coba kembali dalam beberapa saat
            lagi.
          </Typography>
        </motion.div>
