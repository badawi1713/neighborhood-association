...
function ProductListFilterDialog({ open, closeDialogHandler, module }) {
  const dispatch = useDispatch();
  const { productFilterFormData, loadingDialog } = useSelector((state) => state.productReducer);

  const formMethods = useForm({
    mode: 'onChange',
    defaultValues: useMemo(() => {
      return productFilterFormData;
...
ProductListFilterDialog.defaultProps = {
  closeDialogHandler: () => {
...
export default ProductListFilterDialog;
